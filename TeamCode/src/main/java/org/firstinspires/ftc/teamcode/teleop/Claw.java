...
public class Claw {
    ...
    public static final double right_claw_open_position = 0.35;
    public static final double right_claw_close_position = 0;
    public static final double left_claw_tilt_intake = 0.11;
    public static final double right_claw_tilt_intake = 0.105;
    public static final double left_claw_tilt_deposit = 0.34;
    public static final double right_claw_tilt_deposit = 0.45;
